...
`ifdef FUNCTIONAL
`include "sky130_fd_sc_hd__lpflow_inputiso0p.functional.pp.v"
`else  // FUNCTIONAL
`include "sky130_fd_sc_hd__lpflow_inputiso0p.timing.pp.v"
`endif // FUNCTIONAL
...
`else  // FUNCTIONAL
`include "sky130_fd_sc_hd__lpflow_inputiso0p.timing.v"
`endif // FUNCTIONAL
