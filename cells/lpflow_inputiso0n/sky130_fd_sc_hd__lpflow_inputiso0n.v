...
`ifdef FUNCTIONAL
`include "sky130_fd_sc_hd__lpflow_inputiso0n.functional.pp.v"
`else  // FUNCTIONAL
`include "sky130_fd_sc_hd__lpflow_inputiso0n.timing.pp.v"
`endif // FUNCTIONAL
...
`else  // FUNCTIONAL
`include "sky130_fd_sc_hd__lpflow_inputiso0n.timing.v"
`endif // FUNCTIONAL
