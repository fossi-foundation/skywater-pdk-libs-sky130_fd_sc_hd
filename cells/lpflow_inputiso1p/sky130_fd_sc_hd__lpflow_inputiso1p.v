...
`ifdef FUNCTIONAL
`include "sky130_fd_sc_hd__lpflow_inputiso1p.functional.pp.v"
`else  // FUNCTIONAL
`include "sky130_fd_sc_hd__lpflow_inputiso1p.timing.pp.v"
`endif // FUNCTIONAL
...
`else  // FUNCTIONAL
`include "sky130_fd_sc_hd__lpflow_inputiso1p.timing.v"
`endif // FUNCTIONAL
