...
`ifdef FUNCTIONAL
`include "sky130_fd_sc_hd__lpflow_inputisolatch.functional.pp.v"
`else  // FUNCTIONAL
`include "sky130_fd_sc_hd__lpflow_inputisolatch.timing.pp.v"
`endif // FUNCTIONAL
...
`else  // FUNCTIONAL
`include "sky130_fd_sc_hd__lpflow_inputisolatch.timing.v"
`endif // FUNCTIONAL
