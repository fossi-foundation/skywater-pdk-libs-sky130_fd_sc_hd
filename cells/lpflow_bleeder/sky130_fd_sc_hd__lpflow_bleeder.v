...
`ifdef FUNCTIONAL
`include "sky130_fd_sc_hd__lpflow_bleeder.functional.pp.v"
`else  // FUNCTIONAL
`include "sky130_fd_sc_hd__lpflow_bleeder.timing.pp.v"
`endif // FUNCTIONAL
...
`else  // FUNCTIONAL
`include "sky130_fd_sc_hd__lpflow_bleeder.timing.v"
`endif // FUNCTIONAL
