...
`ifdef FUNCTIONAL
`include "sky130_fd_sc_hd__lpflow_isobufsrc.functional.pp.v"
`else  // FUNCTIONAL
`include "sky130_fd_sc_hd__lpflow_isobufsrc.timing.pp.v"
`endif // FUNCTIONAL
...
`else  // FUNCTIONAL
`include "sky130_fd_sc_hd__lpflow_isobufsrc.timing.v"
`endif // FUNCTIONAL
