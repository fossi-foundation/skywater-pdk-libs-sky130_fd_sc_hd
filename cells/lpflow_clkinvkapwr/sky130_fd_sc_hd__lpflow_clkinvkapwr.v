...
`ifdef FUNCTIONAL
`include "sky130_fd_sc_hd__lpflow_clkinvkapwr.functional.pp.v"
`else  // FUNCTIONAL
`include "sky130_fd_sc_hd__lpflow_clkinvkapwr.timing.pp.v"
`endif // FUNCTIONAL
...
`else  // FUNCTIONAL
`include "sky130_fd_sc_hd__lpflow_clkinvkapwr.timing.v"
`endif // FUNCTIONAL
