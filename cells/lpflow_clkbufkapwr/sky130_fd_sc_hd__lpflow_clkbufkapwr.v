...
`ifdef FUNCTIONAL
`include "sky130_fd_sc_hd__lpflow_clkbufkapwr.functional.pp.v"
`else  // FUNCTIONAL
`include "sky130_fd_sc_hd__lpflow_clkbufkapwr.timing.pp.v"
`endif // FUNCTIONAL
...
`else  // FUNCTIONAL
`include "sky130_fd_sc_hd__lpflow_clkbufkapwr.timing.v"
`endif // FUNCTIONAL
