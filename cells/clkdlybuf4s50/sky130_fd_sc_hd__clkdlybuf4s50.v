...
`ifdef FUNCTIONAL
`include "sky130_fd_sc_hd__clkdlybuf4s50.functional.pp.v"
`else  // FUNCTIONAL
`include "sky130_fd_sc_hd__clkdlybuf4s50.timing.pp.v"
`endif // FUNCTIONAL
...
`else  // FUNCTIONAL
`include "sky130_fd_sc_hd__clkdlybuf4s50.timing.v"
`endif // FUNCTIONAL
