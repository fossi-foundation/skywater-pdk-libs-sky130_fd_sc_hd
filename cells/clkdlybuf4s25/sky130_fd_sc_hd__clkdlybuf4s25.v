...
`ifdef FUNCTIONAL
`include "sky130_fd_sc_hd__clkdlybuf4s25.functional.pp.v"
`else  // FUNCTIONAL
`include "sky130_fd_sc_hd__clkdlybuf4s25.timing.pp.v"
`endif // FUNCTIONAL
...
`else  // FUNCTIONAL
`include "sky130_fd_sc_hd__clkdlybuf4s25.timing.v"
`endif // FUNCTIONAL
